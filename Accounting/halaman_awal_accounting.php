                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $total_barang; ?> Barang</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col mr-2">
                            ...
                            <?php
                            include "koneksi.php";
                            $order_b = "SELECT * FROM tbl_penjualan";
                            ...
                            <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $count_b; ?> Barang
                                Masuk
                            </div>
                        </div>
                        <div class="col-auto">
...
//                            ?>
<!--                            <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800">--><?php //echo $count_a; ?><!-- Barang-->
<!--                                Keluar-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="col-auto">-->
...
//                            ?>
<!---->
<!--                            <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800">--><?php //echo $count_d; ?><!--Pembelian-->
<!--                            </div>-->
<!--                        </div>-->
<!--                        <div class="col-auto">-->
<!--                            <a href="dashboard_accounting?p=data_pembelian"><i-->
<!--                                        class="fas fa-fw fa-book fa-2x text-warning" style="margin-top: 18px;"></i></a>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
